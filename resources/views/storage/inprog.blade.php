        ...
        <div class="row mt-0">
            ...
            <div class="col-3 border border-secondary p-5">
                ...
                <div class="d-flex bd-highlight  mb-4">
                    <a href="/storage/ready-proc" class="btn btn-outline-secondary"> <div class="">Ready To Process</div></a>
                    <a href="/storage/in-prog" class="btn btn-secondary"><div class="">In Progress</div></a>
                </div>
                ...
                @foreach($data as $d)
                    @if($x == $d->recipt)
                    @else
                        <a href="/storage/in-prog/{{$d->recipt}}" class="btn btn-outline-secondary w-100 m-3">
                ...
                <div class="container mt-4">
                    <div class="row">
                        ...
                        <div class="col-5"><div class="d-flex bd-highlight border border-secondary mb-2">
                                ...
                                <div class="p-2 flex-fill bd-highlight" style="color: #FFDF37;">In Progress</div>
                            </div>
                        ...
                        <div class="container mt-4 border w-border shadow p-3 pb-0 bg-body rounded">
                            ...
                            <table class="table">
                                ...
                                <?php $totalqty = 0 ; $totalprice = 0; $y=0;?>
                                @foreach($isi as $y)
                                    <tr>
                                        ...
                                        <?php $totalqty += $y['quantity']; $totalprice += $y['quantity'] * $y->product['price']?>
                        ...
                        <form action="/storage/in-prog/{{$recipt}}/post/{{$totalprice}}/{{$totalqty}}" class="w-100">
